              ...
              {depositStep === 'amount' && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-zinc-400 font-bold ml-1 uppercase tracking-widest">Valor mínimo: R$ 300,00</p>
                  </div>
                  <button 
                    disabled={!depositAmount || parseFloat(depositAmount) < 300}
