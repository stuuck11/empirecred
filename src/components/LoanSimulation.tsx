...
export default function LoanSimulation({ profile, setProfile }: { profile: UserProfile | null, setProfile: (p: UserProfile) => void }) {
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-2xl font-bold text-sm border-2 border-zinc-100 hover:bg-zinc-50 transition-colors"
                >
                  Copiar código PIX
                </button>
